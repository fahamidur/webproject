...
<form method="post">
  <div class="row">
                       ...
                       <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="regmobilenumber" name="regmobilenumber" placeholder="Please enter your registered mobile number" pattern="[0-9]{11}" title="11 numeric characters only" required="true" maxlength="10">
                                        </div>
<div class="form-group">
