    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 mx-auto">
          ...
          <p class="lead">This project was made by Tawhid Ahmed Komol, Student of Daffodil International University and was made for educational purpose. This project was monitored and guided by our course teacher of Database Management System Md. Jahangir Alom Sir. </p>
...
Reported illnesses have ranged from mild symptoms to severe illness and death</p>
  ...
  <footer class="py-5 bg-dark">
    <div class="container">
      <p class="m-0 text-center text-white">Copyright &copy; Tawhid Ahmed Komol 2021</p>
    </div>
    <!-- /.container -->
  </footer>
